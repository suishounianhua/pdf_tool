...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	{
	    $xml = $this->createXml();
//	    CakeLog::debug('wxpay post xml:'.$xml);
        Di::getDefault()->get('logger')->log('wxpay post xml:'.$xml);
...
{	
	...
	{
		$this->postXml();
//		CakeLog::info("prepay_id response:".$this->response);
        Di::getDefault()->get('logger')->log("prepay_id response:".$this->response);
		$this->result = $this->xmlToArray($this->response);		
