...
class AopClient {
	...
	*/
	...
	protected function buildRequestForm($para_temp) {
		...
		$sHtml = "<form id='alipaysubmit' target='iframe-alipay' name='alipaysubmit' action='".$this->gatewayUrl."?charset=".trim($this->postCharset)."' method='POST'>";
        ...
        $sHtml .= '<input id="btn-alipaysubmit" type="submit" value="支付宝支付" style="background:#408bde;border-color:#408bde;color:white;" class="btn btn-block"></form>';
